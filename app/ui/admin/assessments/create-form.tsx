...
import { createAssessment } from "@/app/lib/action/assessment/action";
...
export default function CreateAssessmentForm({
  ...
  // Who the assessment targets. Grade is always chosen; for a class scope, a
  // second picker (filtered to that grade) chooses the class.
  ...
  const [state, formAction] = useActionState(createAssessment, initialSate);
